...
<div class="wrap">
    <?php
    NavBar::begin([
        'brandLabel' => 'Ms Chris Digital Accessories',
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => 'Images', 'url' => ['/site/showroom'], 'visible' => !Yii::$app->user->isGuest],
...
<footer class="footer">
    <div class="container">
        <p class="pull-left">&copy; Ms Chris Digital Accessories <?= date('Y') ?></p>
